  ...
  return (
    <div className="min-h-screen ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Join thousands of learners from around the world on your journey"
              }
            ].map((feature, index) => (
              <div key={index} className="text-center p-8 rounded-xl hover:shadow-lg transition-shadow duration-300">
                ...
                <h3 className="text-2xl font-bold text-[#1c4645] mb-4">{feature.title}</h3>
      ...
      <section className="py-20 bg-[#1c4645] text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            {[
              { icon: <Users className="h-8 w-8" />, number: "10,000+", label: "Active Students" },
              { icon: <BookOpen className="h-8 w-8" />, number: "500+", label: "Courses" },
              { icon: <Trophy className="h-8 w-8" />, number: "50+", label: "Expert Instructors" },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1c4645] mb-4">What Our Students Say</h2>
            ...
            {[
              {
                ...
                quote: 'Vigyana helped me learn full-stack development at my own pace! The instructors are amazing and the content is top-notch.',
                rating: 5
              },
              {
                name: 'Priya S.',
                role: 'UI/UX Designer',
                quote: 'Super clean interface, top-quality instructors. Love it! The courses are well-structured and easy to follow.',
                rating: 5
              },
              {
                name: 'Rohan K.',
                role: 'Software Engineer',
                quote: 'I got my first job after completing 2 courses on Vigyana. The practical projects really helped me build a strong portfolio.',
                rating: 5
              },
              ...
              <div key={index} className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-bold text-[#1c4645]">{testimonial.name}</p>
